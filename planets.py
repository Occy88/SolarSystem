...
def main():
    ...
    shipS = pygame.transform.scale(pygame.image.load("ship stuff\ship.png"), (20, 20))
    shipS2 = pygame.transform.scale(pygame.image.load("ship stuff\ship2.png"), (20, 20))
    COUNTER_A=0
    COUNTER_B=0
    # -------- Main Program Loop -----------
    while not done:
...
#                    ship.velocityX -=1
       ...
       # pygame.draw.line(screen,WHITE,(ship.x,ship.y),(x,y),2)
        ...
        text=font.render(str(COUNTER_B)+"   -   "+str(int(pygame.time.get_ticks()/1000))+"   -   "+str(COUNTER_A), 1,(255,255,255))
