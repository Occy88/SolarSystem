...
#                    makeBullet()
 ...
 #       def makeBullet():
 #           bullet = Planet()
 #           bullet.x = ship.x + ship.velocityX
 #           bullet.y = ship.y + ship.velocityY
 #           bullet.MASS = 0.5
 #           bullet.velocityX = ship.velocityX * 5
 #           bullet.velocityY = ship.velocityY * 5
 #           bullet_list.append(bullet)
        clock.tick(60)
        screen.fill(BLACK)
        ship.x+=ship.velocityX
        ship.y+=ship.velocityY
        tempShip = pygame.transform.rotozoom(shipS, -ship.angleFromNormal*90, 1)
#        for i in range(len(bullet_list)):
#            bullet_list[i] = pygame.transform.scale(pygame.image.load("C:\\Users\Sorrin\Desktop\Bullet.png"),
#                                          (10, 10))
#        bullet.x += bullet.velocityX
#        bullet.y += bullet.velocityY
#        screen.blit(bullet_list[i], (bullet.x, bullet.y))
